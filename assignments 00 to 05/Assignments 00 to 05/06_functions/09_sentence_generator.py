...
# # Implement the helper function make_sentence(word, part_of_speech) which will take a 
# string word and an integer part_of_speech as parameters and, depending on the part of 
# speech, place the word into one of three sentence templates (or one from your imagination!):
...
# "Looking out my window, the sky is big and ____!" make_sentence(word, part_of_speech) should not return anything, just print the correct sentence with the word filled in the blank.
